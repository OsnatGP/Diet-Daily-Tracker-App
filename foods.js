/* ═══════════════════════════════════════════════════════
   ...
   cal = kcal per 100g  |  pro = protein g per 100g
   srv = default serving in grams
   srvName = name of one serving (for display)
   keys = all searchable terms (Hebrew + English + aliases)
═══════════════════════════════════════════════════════ */

window.FOOD_DB = [

  /* ──── EGGS ──── */
  {id:'egg',        cal:155, pro:13,  srv:55,  srvName:'ביצה בינונית',
  ...
  /* ──── CHICKEN ──── */
  {id:'chicken_breast', cal:165, pro:31, srv:120, srvName:'חזה עוף בינוני',
   keys:['חזה עוף','עוף','עוף צלוי','עוף מבושל','עוף בתנור','שניצל עוף','chicken','chicken breast','grilled chicken','baked chicken']},
  {id:'chicken_thigh',  cal:209, pro:26, srv:120, srvName:'ירך עוף',
   keys:['ירך עוף','כרעיים','chicken thigh','chicken leg']},
  {id:'chicken_wing',   cal:203, pro:30, srv:80,  srvName:'כנף עוף',
   keys:['כנפיים','כנף עוף','chicken wing','wings']},
  {id:'schnitzel',      cal:230, pro:20, srv:120, srvName:'שניצל',
   keys:['שניצל','שניצל עוף','schnitzel']},

  /* ──── BEEF & MEAT ──── */
  {id:'beef_ground',    cal:250, pro:26, srv:120, srvName:'מנת בשר טחון',
   keys:['בשר טחון','קציצה','המבורגר','המבורגר ביתי','ground beef','hamburger','burger','meatball','קציצות']},
  {id:'beef_steak',     cal:271, pro:26, srv:150, srvName:'סטייק',
   keys:['סטייק','אנטריקוט','פילה בקר','בשר בקר','steak','beef','ribeye','sirloin']},
  {id:'turkey_breast',  cal:135, pro:30, srv:100, srvName:'חזה הודו',
   keys:['חזה הודו','הודו','turkey','turkey breast']},
  {id:'deli_turkey',    cal:110, pro:18, srv:60,  srvName:'3 פרוסות הודו',
   keys:['נקניק הודו','הודו קר','פרוסות הודו','deli turkey','turkey slices']},
  {id:'sausage',        cal:290, pro:12, srv:80,  srvName:'נקניקייה',
   keys:['נקניקייה','נקניקיות','נקניק','hotdog','sausage','frankfurter']},
  {id:'lamb',           cal:294, pro:25, srv:120, srvName:'מנת כבש',
   keys:['כבש','טלה','כבוב','lamb','kebab']},

  /* ──── FISH & SEAFOOD ──── */
  {id:'tuna_can',       cal:116, pro:26, srv:100, srvName:'פחית טונה',
   keys:['טונה','טונה בשימורים','tuna','canned tuna','tuna can']},
  {id:'salmon',         cal:208, pro:20, srv:150, srvName:'פילה סלמון',
   keys:['סלמון','דג סלמון','salmon','grilled salmon']},
  {id:'tilapia',        cal:96,  pro:20, srv:150, srvName:'פילה אמנון',
   keys:['אמנון','דג אמנון','tilapia','fish fillet','פילה דג']},
  {id:'sardines',       cal:208, pro:25, srv:90,  srvName:'קופסת סרדינים',
   keys:['סרדינים','sardines','sardine']},
  {id:'shrimp',         cal:99,  pro:24, srv:120, srvName:'מנת שרימפס',
  ...
  {id:'white_cheese_5', cal:90,  pro:9,  srv:200, srvName:'גביע גבינה לבנה 5%',
   keys:['גבינה לבנה','גבינה לבנה 5%','גבינה לבנה 9%','white cheese','cream cheese light']},
  {id:'feta',           cal:264, pro:14, srv:50,  srvName:'50g גבינה בולגרית',
   keys:['גבינה בולגרית','פטה','feta','bulgarian cheese','בולגרית']},
  {id:'ricotta',        cal:174, pro:11, srv:100, srvName:'100g ריקוטה',
   keys:['ריקוטה','ricotta']},
  {id:'mozzarella',     cal:280, pro:28, srv:80,  srvName:'80g מוצרלה',
   keys:['מוצרלה','mozzarella']},
  {id:'parmesan',       cal:431, pro:38, srv:15,  srvName:'כף פרמזן',
   keys:['פרמזן','parmesan','parmigiano']},
  {id:'cream_cheese',   cal:342, pro:6,  srv:30,  srvName:'כף שמנת',
   keys:['שמנת','שמנת מתוקה','cream cheese','philadelphia','שמנת גבינה']},

  /* ──── DAIRY — MILK & YOGURT ──── */
  {id:'milk',           cal:61,  pro:3.2,srv:250, srvName:'כוס חלב',
   keys:['חלב','milk','whole milk','חלב מלא','חלב 3%']},
  {id:'milk_low',       cal:42,  pro:3.4,srv:250, srvName:'כוס חלב דל שומן',
   keys:['חלב דל שומן','חלב 1%','milk 1%','skim milk','low fat milk']},
  {id:'yogurt',         cal:100, pro:4,  srv:200, srvName:'גביע יוגורט',
   keys:['יוגורט','yogurt','יוגורט טבעי','plain yogurt']},
  {id:'yogurt_greek',   cal:130, pro:10, srv:200, srvName:'גביע יוגורט יווני',
   keys:['יוגורט יווני','greek yogurt','יוגורט יוונ']},
  {id:'sour_cream',     cal:193, pro:2.4,srv:50,  srvName:'2 כפות שמנת חמוצה',
   keys:['שמנת חמוצה','sour cream']},
  {id:'leben',          cal:65,  pro:3.3,srv:250, srvName:'גביע לבן',
  ...
  {id:'chickpeas',      cal:164, pro:9,  srv:150, srvName:'מנת חומוס מבושל',
   keys:['גרגרי חומוס','חומוס מבושל','chickpeas','garbanzo']},
  {id:'lentils',        cal:116, pro:9,  srv:150, srvName:'מנת עדשים',
   keys:['עדשים','עדשים מבושלות','lentils','lentil soup','מרק עדשים']},
  {id:'beans_red',      cal:127, pro:8.7,srv:150, srvName:'מנת שעועית',
   keys:['שעועית','שעועית אדומה','red beans','kidney beans','פול']},
  {id:'tofu',           cal:76,  pro:8,  srv:120, srvName:'120g טופו',
   keys:['טופו','tofu']},
  {id:'edamame',        cal:121, pro:11, srv:100, srvName:'100g אדמאמה',
   keys:['אדמאמה','edamame']},

  /* ──── GRAINS — BREAD ──── */
  {id:'bread_white',    cal:265, pro:9,  srv:30,  srvName:'פרוסת לחם לבן',
   keys:['לחם לבן','פרוסת לחם','לחם','bread','white bread','toast','טוסט']},
  {id:'bread_whole',    cal:247, pro:10, srv:30,  srvName:'פרוסת לחם מחיטה מלאה',
   keys:['לחם מחיטה מלאה','לחם שחור','whole wheat bread','whole grain bread','לחם מלא']},
  {id:'bread_rye',      cal:259, pro:9,  srv:30,  srvName:'פרוסת לחם שיפון',
   keys:['לחם שיפון','rye bread','pumpernickel']},
  {id:'pita',           cal:275, pro:9,  srv:60,  srvName:'פיתה',
   keys:['פיתה','pita','pitta','pita bread']},
  {id:'laffa',          cal:270, pro:8,  srv:80,  srvName:'לאפה',
   keys:['לאפה','laffa','wrap','wrp']},
  {id:'cracker',        cal:420, pro:9,  srv:20,  srvName:'4 קרקרים',
   keys:['קרקר','קרקרים','cracker','rice cake','קציר']},
  {id:'bagel',          cal:270, pro:10, srv:90,  srvName:'בייגלה',
   keys:['בייגלה','בייגל','bagel']},

  /* ──── GRAINS — COOKED ──── */
  {id:'rice_white',     cal:130, pro:2.7,srv:180, srvName:'מנת אורז לבן',
   keys:['אורז','אורז לבן','rice','white rice','cooked rice']},
  {id:'rice_brown',     cal:123, pro:2.7,srv:180, srvName:'מנת אורז מלא',
   keys:['אורז מלא','brown rice','אורז חום']},
  {id:'pasta',          cal:131, pro:5,  srv:200, srvName:'מנת פסטה מבושלת',
   keys:['פסטה','ספגטי','מקרוני','pasta','spaghetti','macaroni','פנה','penne']},
  {id:'couscous',       cal:112, pro:3.8,srv:180, srvName:'מנת קוסקוס',
   keys:['קוסקוס','couscous']},
  {id:'bulgur',         cal:83,  pro:3.1,srv:180, srvName:'מנת בורגול',
   keys:['בורגול','bulgur','פרו','freekeh','פריקה']},
  {id:'oats',           cal:389, pro:17, srv:40,  srvName:'חצי כוס שיבולת שועל יבשה',
   keys:['שיבולת שועל','קוואקר','פתיתי שבולת שועל','oats','oatmeal','granola','גרנולה']},
  {id:'quinoa',         cal:120, pro:4.4,srv:180, srvName:'מנת קינואה',
   keys:['קינואה','quinoa']},
  {id:'corn',           cal:86,  pro:3.3,srv:150, srvName:'תירס',
   keys:['תירס','תירס מבושל','corn','sweet corn','maize']},

  /* ──── VEGETABLES ──── */
  {id:'tomato',         cal:18,  pro:0.9,srv:150, srvName:'עגבנייה',
   keys:['עגבנייה','עגבניה','עגבניות','tomato','tomatoes']},
  {id:'cucumber',       cal:16,  pro:0.7,srv:130, srvName:'מלפפון',
   keys:['מלפפון','מלפפונים','cucumber']},
  {id:'lettuce',        cal:15,  pro:1.4,srv:100, srvName:'קערת חסה',
   keys:['חסה','חסה ירוקה','lettuce','salad leaves','רוקט','rocket','arugula']},
  {id:'pepper',         cal:31,  pro:1,  srv:120, srvName:'פלפל',
   keys:['פלפל','פלפל אדום','פלפל ירוק','פלפל צהוב','bell pepper','pepper']},
  {id:'carrot',         cal:41,  pro:0.9,srv:100, srvName:'גזר',
   keys:['גזר','גזרים','carrot','carrots']},
  {id:'spinach',        cal:23,  pro:2.9,srv:100, srvName:'100g תרד',
   keys:['תרד','spinach']},
  {id:'broccoli',       cal:34,  pro:2.8,srv:150, srvName:'מנת ברוקולי',
   keys:['ברוקולי','broccoli']},
  {id:'cauliflower',    cal:25,  pro:2,  srv:150, srvName:'מנת כרובית',
   keys:['כרובית','cauliflower']},
  {id:'cabbage',        cal:25,  pro:1.3,srv:100, srvName:'100g כרוב',
   keys:['כרוב','cabbage','coleslaw','כרוב כבוש','sauerkraut']},
  {id:'onion',          cal:40,  pro:1.1,srv:80,  srvName:'בצל',
   keys:['בצל','בצלים','onion','onions']},
  {id:'zucchini',       cal:17,  pro:1.2,srv:150, srvName:'קישוא',
   keys:['קישוא','קישואים','zucchini','courgette']},
  {id:'eggplant',       cal:25,  pro:1,  srv:150, srvName:'חצי חציל',
   keys:['חציל','חצילים','eggplant','aubergine']},
  {id:'mushrooms',      cal:22,  pro:3.1,srv:100, srvName:'100g פטריות',
   keys:['פטריות','פטרייה','mushroom','mushrooms']},
  {id:'sweet_potato',   cal:86,  pro:1.6,srv:150, srvName:'בטטה בינונית',
   keys:['בטטה','sweet potato','yam']},
  {id:'potato',         cal:87,  pro:2,  srv:150, srvName:'תפוח אדמה בינוני',
   keys:['תפוח אדמה','תפו"א','תפוח-אדמה','potato','potatoes','מרק','בטטה מבושלת']},
  {id:'avocado',        cal:160, pro:2,  srv:100, srvName:'חצי אבוקדו',
   keys:['אבוקדו','avocado']},
  {id:'corn_canned',    cal:86,  pro:3.3,srv:100, srvName:'100g תירס מקופסא',
   keys:['תירס מקופסא','תירס שימורים','canned corn']},

  /* ──── FRUITS ──── */
  {id:'apple',          cal:52,  pro:0.3,srv:182, srvName:'תפוח בינוני',
   keys:['תפוח','תפוח עץ','apple']},
  {id:'banana',         cal:89,  pro:1.1,srv:118, srvName:'בננה בינונית',
   keys:['בננה','banana']},
  {id:'orange',         cal:47,  pro:0.9,srv:131, srvName:'תפוז',
   keys:['תפוז','תפוזים','orange']},
  {id:'watermelon',     cal:30,  pro:0.6,srv:300, srvName:'פרוסת אבטיח',
   keys:['אבטיח','watermelon']},
  {id:'grapes',         cal:69,  pro:0.7,srv:150, srvName:'אשכול ענבים',
   keys:['ענבים','ענב','grapes','grape']},
  {id:'strawberry',     cal:32,  pro:0.7,srv:150, srvName:'קערת תותים',
   keys:['תות','תותים','strawberry','strawberries']},
  {id:'melon',          cal:34,  pro:0.8,srv:250, srvName:'פרוסת מלון',
   keys:['מלון','melon','cantaloupe']},
  {id:'mango',          cal:60,  pro:0.8,srv:200, srvName:'מנגו בינוני',
   keys:['מנגו','mango']},
  {id:'pear',           cal:57,  pro:0.4,srv:178, srvName:'אגס',
   keys:['אגס','pear']},
  {id:'peach',          cal:39,  pro:0.9,srv:150, srvName:'אפרסק',
   keys:['אפרסק','peach','nectarine','נקטרינה']},
  {id:'kiwi',           cal:61,  pro:1.1,srv:76,  srvName:'קיווי',
   keys:['קיווי','kiwi']},
  {id:'dates',          cal:282, pro:2.5,srv:30,  srvName:'3 תמרים',
   keys:['תמר','תמרים','dates','date']},
  {id:'raisins',        cal:299, pro:3.1,srv:30,  srvName:'חופן צימוקים',
   keys:['צימוקים','raisins']},

  /* ──── FATS & SPREADS ──── */
  {id:'olive_oil',      cal:884, pro:0,  srv:10,  srvName:'כף שמן זית',
   keys:['שמן זית','olive oil','oil','שמן']},
  {id:'tahini',         cal:595, pro:17, srv:30,  srvName:'2 כפות טחינה',
   keys:['טחינה','tahini','sesame paste']},
  {id:'peanut_butter',  cal:588, pro:25, srv:32,  srvName:'2 כפות חמאת בוטנים',
   keys:['חמאת בוטנים','peanut butter','pb']},
  {id:'almond_butter',  cal:614, pro:21, srv:32,  srvName:'2 כפות חמאת שקדים',
   keys:['חמאת שקדים','almond butter']},
  {id:'butter',         cal:717, pro:0.9,srv:10,  srvName:'כפית חמאה',
   keys:['חמאה','butter','margarine','מרגרינה']},
  {id:'mayonnaise',     cal:680, pro:1,  srv:15,  srvName:'כף מיונז',
  ...
  {id:'falafel',        cal:333, pro:13, srv:100, srvName:'4 פלאפל',
   keys:['פלאפל','falafel']},
  {id:'burekas',        cal:360, pro:8,  srv:90,  srvName:'בורקס',
   keys:['בורקס','בורקס גבינה','בורקס תפו"א','burekas','bourekas']},
  {id:'sabich',         cal:310, pro:14, srv:300, srvName:'סביח',
   keys:['סביח','sabich']},
  {id:'shawarma',       cal:200, pro:18, srv:200, srvName:'מנת שווארמה',
   keys:['שווארמה','shawarma']},
  {id:'malabi',         cal:150, pro:4,  srv:150, srvName:'מלבי',
   keys:['מלבי','malabi']},
  {id:'soup',           cal:60,  pro:3,  srv:300, srvName:'קערת מרק',
   keys:['מרק','מרק ירקות','מרק עוף','soup','chicken soup','vegetable soup']},
  {id:'salad_israeli',  cal:80,  pro:2,  srv:200, srvName:'סלט ישראלי',
   keys:['סלט ישראלי','סלט ירקות','israeli salad','vegetable salad','סלט']},
  {id:'rice_and_lentils',cal:150,pro:6, srv:200, srvName:'מנת מג׳דרה',
   keys:['מג׳דרה','מגדרה','mujaddara']},

  /* ──── NUTS & SEEDS ──── */
  {id:'almonds',        cal:579, pro:21, srv:30,  srvName:'חופן שקדים',
   keys:['שקדים','almonds','almond']},
  {id:'walnuts',        cal:654, pro:15, srv:30,  srvName:'חופן אגוזי מלך',
   keys:['אגוזי מלך','אגוזים','walnuts','walnut']},
  {id:'cashews',        cal:553, pro:18, srv:30,  srvName:'חופן קשיו',
   keys:['קשיו','cashews','cashew']},
  {id:'pistachios',     cal:562, pro:20, srv:30,  srvName:'חופן פיסטוק',
   keys:['פיסטוק','pistachios','pistachio']},
  {id:'sunflower_seeds',cal:584, pro:21, srv:30,  srvName:'חופן גרעינים',
   keys:['גרעינים','גרעיני חמנייה','sunflower seeds','seeds']},
  {id:'pumpkin_seeds',  cal:559, pro:30, srv:30,  srvName:'חופן גרעיני דלעת',
   keys:['גרעיני דלעת','pumpkin seeds']},

  /* ──── SNACKS & PROCESSED ──── */
  {id:'chips',          cal:536, pro:7,  srv:30,  srvName:'חבילת צ׳יפס קטנה',
   keys:['צ׳יפס','ציפס','chips','potato chips','crisps']},
  {id:'pretzels',       cal:380, pro:10, srv:30,  srvName:'חופן פרצלים',
   keys:['פרצלים','בייגלה','pretzels','pretzel']},
  {id:'popcorn',        cal:375, pro:11, srv:30,  srvName:'קערת פופקורן',
   keys:['פופקורן','popcorn']},
  {id:'chocolate',      cal:546, pro:5,  srv:30,  srvName:'3 קוביות שוקולד',
   keys:['שוקולד','chocolate','dark chocolate','שוקולד מריר']},
  {id:'ice_cream',      cal:207, pro:3.5,srv:100, srvName:'גביע גלידה',
   keys:['גלידה','ice cream','icecream']},
  {id:'cake',           cal:350, pro:5,  srv:100, srvName:'פרוסת עוגה',
   keys:['עוגה','cake','tort','טורט']},
  {id:'cookie',         cal:480, pro:6,  srv:30,  srvName:'2 עוגיות',
   keys:['עוגייה','עוגיות','cookie','cookies','biscuit']},
  {id:'croissant',      cal:406, pro:8,  srv:60,  srvName:'קרואסון',
   keys:['קרואסון','croissant']},
  {id:'muffin',         cal:375, pro:6,  srv:100, srvName:'מאפין',
   keys:['מאפין','muffin']},
  {id:'pizza',          cal:266, pro:11, srv:150, srvName:'פרוסת פיצה',
   keys:['פיצה','pizza']},

  /* ──── PROTEIN SUPPLEMENTS ──── */
  {id:'protein_shake',  cal:120, pro:25, srv:30,  srvName:'מנת אבקת חלבון',
   keys:['אבקת חלבון','שייק חלבון','protein powder','protein shake','whey','whey protein']},
  {id:'protein_bar',    cal:200, pro:20, srv:60,  srvName:'חטיף חלבון',
   keys:['חטיף חלבון','protein bar','quest bar']},

  /* ──── BEVERAGES (with cals) ──── */
  {id:'orange_juice',   cal:45,  pro:0.7,srv:250, srvName:'כוס מיץ תפוזים',
   keys:['מיץ תפוזים','מיץ','juice','orange juice','מיץ טבעי']},
  {id:'coffee_milk',    cal:35,  pro:1.8,srv:250, srvName:'כוס קפה עם חלב',
   keys:['קפה עם חלב','קפה הפוך','הפוך','לאטה','קפוצ׳ינו','latte','cappuccino','coffee with milk']},
  {id:'smoothie',       cal:100, pro:2,  srv:300, srvName:'שייק פירות',
   keys:['שייק','שייק פירות','smoothie','fruit smoothie']},

  /* ──── SAUCES & CONDIMENTS ──── */
  {id:'ketchup',        cal:112, pro:1.6,srv:15,  srvName:'כף קטשופ',
   keys:['קטשופ','ketchup','catsup']},
  {id:'mustard',        cal:66,  pro:4,  srv:10,  srvName:'כפית חרדל',
   keys:['חרדל','mustard']},
  {id:'hot_sauce',      cal:30,  pro:1,  srv:15,  srvName:'כף חריף',
   keys:['חריף','רוטב חריף','hot sauce','sriracha','סריראצ׳ה']},
  {id:'soy_sauce',      cal:53,  pro:8,  srv:15,  srvName:'כף סויה',
...
═══════════════════════════════════ */
window.lookupFood = function(rawText) {
  ...
  const pro = Math.round(best.pro * grams / 100 * 10) / 10;
